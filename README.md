...
**System reference:** [jak-ma-eval-suite/docs/architecture.md](https://github.com/Samielakkad/AI-LLM-Evaluation-JakMa/blob/main/docs/architecture.md)
...
The product surface is a chat. The underlying machinery is described in [docs/architecture.md](https://github.com/Samielakkad/AI-LLM-Evaluation-JakMa/blob/main/docs/architecture.md). This document is the *case study* — what shipped, what didn't, what we learned doing it.
...
1. **LoRA fine-tune Llama 3.1 8B for Pass 2.** Target: 3× cost reduction at the current eval-score parity. Compute budget: ~$50 on Modal for the first run. Recipe in [jak-ma-eval-suite/scripts/finetune/](https://github.com/Samielakkad/AI-LLM-Evaluation-JakMa).
...
- **Build the eval suite before building the product.** We built jak.ma, then built the eval suite, then realized the eval suite would have told us to build a different thing. The methodology repo ([ernie-evaluation-notes](https://github.com/Samielakkad/AI-LLM-Evaluation-Baidu-ERNIE)) is the closest thing to "the eval suite I wish I had on day one."
...
- **Write the verifier spec before the verifier.** The [VERIFIER_SPEC.md](https://github.com/Samielakkad/AI-LLM-Evaluation-JakMa/blob/main/VERIFIER_SPEC.md) was written after the verifier shipped. Writing it first would have forced the design conversation upstream.
...
- [docs/architecture.md](https://github.com/Samielakkad/AI-LLM-Evaluation-JakMa/blob/main/docs/architecture.md) — the system paper
- [VERIFIER_SPEC.md](https://github.com/Samielakkad/AI-LLM-Evaluation-JakMa/blob/main/VERIFIER_SPEC.md) — what V1–V6 check
- [pm-frameworks-darija](https://github.com/Samielakkad/AI-Product-Management-Frameworks) — pricing taxonomy, calibration protocol, eval rubric
- [ernie-evaluation-notes](https://github.com/Samielakkad/AI-LLM-Evaluation-Baidu-ERNIE) — the calibration methodology applied here, from the Baidu ERNIE Mentor Program
- [darija-nlp-resources](https://github.com/Samielakkad/AI-NLP-Darija-Resources) — public corpora, papers, tools
